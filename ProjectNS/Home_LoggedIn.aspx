<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home_LoggedIn.aspx.cs" Inherits="ProjectNS.Home_LoggedIn" %>
            ...
            <section id="food" >  
                ...
                <asp:Repeater ID="r1" runat="server">
                    ...
                    <li>
                        ...
                        <asp:Button ID="btnadd" runat="server" Text="Add To Cart" OnClick="AddToCart_Click" CommandArgument='<%# Eval("pid") %>' class="btn btn-primary"></asp:Button>
                   </li>
                    </ItemTemplate>
                 <FooterTemplate>
                </ul>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboutUs_Retailer.aspx.cs" Inherits="ProjectNS.AboutUs_Retailer" %>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav nav-center">
                <li class="nav-item">
                    <a class="nav-link" href="Home_Retailer.aspx">Home</a>
                </li>
                <li class="nav-item">
   ...
   <div class=" jumbotron header">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {  
            const observer = new IntersectionObserver((entries) => { //api used for scrolling
